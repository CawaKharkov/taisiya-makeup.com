		...
		$('.fs-slide').each(function(){
			...
			_slider.find('.swiper-container').swiper({
			    ...
			    onSlideNextStart: function(swiper){
		    		...
		    		_active.find('.fs-animate-text1').each(function(ai){
		    			var _el = $(this);
		    			_el.css({
		    				'-webkit-animation-delay': (ai*0.2)+"s",
		    				   '-moz-animation-delay': (ai*0.2)+"s",
                    ...
                    setTimeout(_active.find('.fs-animate-text2').each(function(ai){
                        var _el = $(this);
                        _el.css({
                            '-webkit-animation-delay': (ai*0.5)+"s",
                            '-moz-animation-delay': (ai*0.5)+"s",
                            '-ms-animation-delay': (ai*0.5)+"s",
                            '-o-animation-delay': (ai*0.5)+"s",
                            'animation-delay': (ai*0.5)+"s"
                        });
                        _el.addClass('animated zoomInRight');
